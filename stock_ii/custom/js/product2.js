	...
	if(productId) {
		...
		$.ajax({
			...
			// alert(response.product_image);
				...
				$("#getProductImage").attr('src', 'stock/'+response.categories_image);
		      ...
		      overwriteInitial: true,
				...
				// product id 
				$(".editProductFooter").append('<input type="hidden" name="categoriesId" id="categoriesId" value="'+response.categories_id+'" />');				
				$(".editProductPhotoFooter").append('<input type="hidden" name="categoriesId" id="categoriesId" value="'+response.categories_id+'" />');				
					...
					if(productImage) {
						...
						$.ajax({
				          ...
				          // reload the manage student table
									...
									$.ajax({
										url: 'php_action/fetchProductImageUrl2.php?i='+productId,
										type: 'post',
										success:function(response) {
