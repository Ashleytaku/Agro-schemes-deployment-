...
<body style="background-color: rgb(7,102,28);">
  ...
  <?php if($valid) {
    ...
    '.$valid.'</div>';										
        ...
        <h1 class="text-center">Register a Government agent </h1>
        <form class="form-signin" action="bankreg.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label for="name">Agent name</label><input type="text" class="form-control" id="UserName" placeholder="Username" name="UserName" value="<?php
                    if($_POST){
                      echo $_POST['UserName'];
                    }
                    ?>" autocomplete="off" required></div>
